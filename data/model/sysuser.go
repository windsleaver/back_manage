...
type SysUser struct {
	...
	UserName       string         `json:"userName" gorm:"column:user_name;type:varchar(32);not null"` //用户名
	...
	HeadImg        string         `json:"headImg" gorm:"column:head_img;type:varchar(512);not null"`  //头像
